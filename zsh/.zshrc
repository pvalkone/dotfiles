...
# Oh-My-ZSH
plugins=(aws brew brew-cask cargo docker docker-machine lein mosh osx sbt scala sudo wd yle-dev zsh-completions zsh-syntax-highlighting history-substring-search)
